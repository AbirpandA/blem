        ...
        <div className="flex flex-col  text-center  max-w-150 gap-5">
          <div>
            <h1 className="text-4xl font-bold tracking-loose ">
              Time to
              <span className="bg-gradient-to-b from-white to-cyan-500/80 bg-clip-text text-transparent">
                Build
              </span>{" "}
              something
            </h1>
          ...
          <PromptInput
            onsubmit={function (value: string, file?: File[]): void {
